...
<body onload="init()">
    ...
    <div class="socialsBarontainer">
        <div class="socialsBar">
            ...
            <a href="https://www.instagram.com/dj.martixx/" target="_blank"><i class="fa fa-instagram fa-4x icon-3d"></i></a>
            <a href="https://soundcloud.com/dj_martixx" target="_blank"><i class="fa fa-soundcloud fa-4x icon-3d"></i></a>
